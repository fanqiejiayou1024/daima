...
<body id="login" class="gray-bg login">
	...
	<div class="loginColumns animated fadeInDown">
		<div class="row">
			...
			<div class="col-md-6">
				<h2 class="font-bold"><img src="erp/images/logo.png" alt="赤龙ERP" width="100" height="40"><span style="vertical-align: middle; font-size: 28px;">ERP</span><span style="vertical-align: middle; font-size: 14px;"> ● 社区版</span></h2>
